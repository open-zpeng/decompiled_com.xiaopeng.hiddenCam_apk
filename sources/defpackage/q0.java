    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray a = a(resources, theme, attributeSet, n0.ColorStateListItem);
                int color = a.getColor(n0.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (a.hasValue(n0.ColorStateListItem_android_alpha)) {
                    f = a.getFloat(n0.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(n0.ColorStateListItem_alpha)) {
                    f = a.getFloat(n0.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != l0.alpha) {
                        int i5 = i3 + 1;
                ...
                iArr2 = u0.a(iArr2, i2, a2);
                iArr = (int[][]) u0.a(iArr, i2, trimStateSet);
                i2++;
            }
            i = 1;
        }
