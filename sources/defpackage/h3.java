...
public class h3 {
    ...
    /* renamed from: h3$a */
    /* loaded from: classes.dex */
    public static class a implements TypeEvaluator<y0.b[]> {
        private y0.b[] a;
        ...
        /* renamed from: a */
        public y0.b[] evaluate(float f, y0.b[] bVarArr, y0.b[] bVarArr2) {
            if (y0.a(bVarArr, bVarArr2)) {
                y0.b[] bVarArr3 = this.a;
                if (bVarArr3 == null || !y0.a(bVarArr3, bVarArr)) {
                    this.a = y0.a(bVarArr);
                }
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long b = w0.b(typedArray, xmlPullParser, "duration", 1, 300);
        long b2 = w0.b(typedArray, xmlPullParser, "startOffset", 2, 0);
        int b3 = w0.b(typedArray, xmlPullParser, "valueType", 7, 4);
        if (w0.a(xmlPullParser, "valueFrom") && w0.a(xmlPullParser, "valueTo")) {
            if (b3 == 4) {
                b3 = a(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(w0.b(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(w0.b(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        String a2 = w0.a(typedArray, xmlPullParser, "pathData", 1);
        if (a2 != null) {
            String a3 = w0.a(typedArray, xmlPullParser, "propertyXName", 2);
            String a4 = w0.a(typedArray, xmlPullParser, "propertyYName", 3);
            if (i != 2) {
            }
            if (a3 == null && a4 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            a(y0.b(a2), objectAnimator, f * 0.5f, a3, a4);
            return;
        }
        objectAnimator.setPropertyName(w0.a(typedArray, xmlPullParser, "propertyName", 0));
    }
    ...
    */
    private static android.animation.Animator a(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.h3.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
        ...
        while (true) {
            ...
            if (eventType == 3 || eventType == 1) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray a2 = w0.a(resources, theme, attributeSet, d3.i);
                    String a3 = w0.a(a2, xmlPullParser, "propertyName", 3);
                    int b = w0.b(a2, xmlPullParser, "valueType", 2, 4);
    ...
    private static int a(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a2 = w0.a(resources, theme, attributeSet, d3.j);
        int i = 0;
        TypedValue b = w0.b(a2, xmlPullParser, "value", 0);
        if ((b != null) && a(b.type)) {
            i = 3;
        }
        a2.recycle();
    ...
    private static PropertyValuesHolder a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i) throws XmlPullParserException, IOException {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            if (i2 == 3) {
                propertyValuesHolder.setEvaluator(i3.a());
            }
        }
        return propertyValuesHolder;
    }
    ...
    private static Keyframe a(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe ofInt;
        TypedArray a2 = w0.a(resources, theme, attributeSet, d3.j);
        float a3 = w0.a(a2, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue b = w0.b(a2, xmlPullParser, "value", 0);
        boolean z = b != null;
        if (i == 4) {
            i = (z && a(b.type)) ? 3 : 0;
        ...
        if (z) {
            if (i != 0) {
                ofInt = (i == 1 || i == 3) ? Keyframe.ofInt(a3, w0.b(a2, xmlPullParser, "value", 0, 0)) : null;
            } else {
                ofInt = Keyframe.ofFloat(a3, w0.a(a2, xmlPullParser, "value", 0, 0.0f));
            }
        } else if (i == 0) {
        ...
        int c = w0.c(a2, xmlPullParser, "interpolator", 1, 0);
        if (c > 0) {
            ofInt.setInterpolator(g3.a(context, c));
        }
        a2.recycle();
        return ofInt;
    }
    ...
    private static ValueAnimator a(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray a2 = w0.a(resources, theme, attributeSet, d3.g);
        TypedArray a3 = w0.a(resources, theme, attributeSet, d3.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        a(valueAnimator, a2, a3, f, xmlPullParser);
        int c = w0.c(a2, xmlPullParser, "interpolator", 0, 0);
        if (c > 0) {
            valueAnimator.setInterpolator(g3.a(context, c));
        }
        a2.recycle();
        if (a3 != null) {
            a3.recycle();
