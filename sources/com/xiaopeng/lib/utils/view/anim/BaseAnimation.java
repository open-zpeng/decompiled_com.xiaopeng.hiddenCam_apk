...
public class BaseAnimation {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$xiaopeng$lib$utils$view$anim$BaseAnimation$AnimationType = new int[AnimationType.values().length];

        static {
            try {
                $SwitchMap$com$xiaopeng$lib$utils$view$anim$BaseAnimation$AnimationType[AnimationType.ROTATE.ordinal()] = 1;
