...
public class NetUtils {
    ...
    public static String getIMEI(Context context) {
        return ((TelephonyManager) context.getSystemService(SkillStatisticsBean.PAGE_PHONE)).getDeviceId();
    }
    ...
    public static String getNetworkOperatorName(Context context) {
        return ((TelephonyManager) context.getSystemService(SkillStatisticsBean.PAGE_PHONE)).getNetworkOperatorName();
    }
    ...
    public static int getSimState(Context context) {
        return ((TelephonyManager) context.getSystemService(SkillStatisticsBean.PAGE_PHONE)).getSimState();
    }
