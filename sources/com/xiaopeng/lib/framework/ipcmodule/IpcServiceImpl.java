...
public class IpcServiceImpl implements IIpcService {
    ...
    public void registerIpcClient(a aVar) throws RemoteException {
        ...
        if (aVar != null) {
            aVar.b(AppInfoUtils.getProcessName(), this.mIPCCallback);
    ...
    public void sendData(int i, Bundle bundle, String... strArr) {
        if (this.mContext != null) {
            if (strArr.length != 0) {
                ...
                ipcMessage.a(this.mContext.getPackageName());
                ipcMessage.a(i);
                ipcMessage.a(bundle);
    ...
    private IpcServiceImpl() {
        ...
        this.mIPCCallback = new b.a() { // from class: com.xiaopeng.lib.framework.ipcmodule.IpcServiceImpl.1
            ...
            public void onReceive(IpcMessage ipcMessage) throws RemoteException {
                Log.i(IpcServiceImpl.TAG, "onReceive:\t sender " + ipcMessage.b() + "\thasSubscriberForEvent:\t" + c.c().a(IIpcService.IpcMessageEvent.class));
                IIpcService.IpcMessageEvent ipcMessageEvent = new IIpcService.IpcMessageEvent();
                ipcMessageEvent.setPayloadData(ipcMessage.c());
                ipcMessageEvent.setMsgID(ipcMessage.a());
                ipcMessageEvent.setSenderPackageName(ipcMessage.b());
                if (c.c().a(IIpcService.IpcMessageEvent.class)) {
                    Log.i(IpcServiceImpl.TAG, "post messageEvent");
                    c.c().a(ipcMessageEvent);
                    return;
                }
                Log.i(IpcServiceImpl.TAG, "postSticky messageEvent");
                c.c().b(ipcMessageEvent);
            }
        };
        ...
        this.mServiceConnection = new ServiceConnection() { // from class: com.xiaopeng.lib.framework.ipcmodule.IpcServiceImpl.4
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                synchronized (IpcServiceImpl.class) {
                    IpcServiceImpl.this.ipcService = a.AbstractBinderC0017a.a(iBinder);
                    try {
            ...
            public void onServiceDisconnected(ComponentName componentName) {
                ...
                synchronized (IpcServiceImpl.class) {
                    ...
                    try {
                        IpcServiceImpl.this.ipcService.a(AppInfoUtils.getProcessName(), IpcServiceImpl.this.mIPCCallback);
                        IpcServiceImpl.this.ipcService.asBinder().unlinkToDeath(IpcServiceImpl.this.mDeathRecipient, 0);
                    } catch (RemoteException e) {
